...
Void Motion stores editor projects locally in the browser. Export processing happens on the user's device. Review the current policy at [void-motion.vercel.app/privacy](https://void-motion.vercel.app/privacy) or in [`PRIVACY.md`](./PRIVACY.md).
